...
class TransformerSelfAttention(nn.Module):
    ...
    def forward(self, hidden_states, attention_mask, head_mask=None):
        ...
        torch.save(attention_probs, '/home/negiryosuke/refine/s3prl/visualaization/mockingjay_model_tensor_165.pt')
...
class TransformerSelfOutput(nn.Module):
    ...
    def forward(self, hidden_states, input_tensor):
        ...
        torch.save(input_tensor, '/home/negiryosuke/refine/s3prl/visualaization/mockingjay_model_tensor_201_input_tensor.pt')
        torch.save(hidden_states, '/home/negiryosuke/refine/s3prl/visualaization/mockingjay_model_tensor_202_hidden_states.pt')
