...
class SpeakerDataset(Dataset):
    ...
    def __init__(self, split, bucket_size, libri_root, split_file, bucket_file, sample_rate=16000, train_dev_seed=1337, **kwargs):        
        ...
        self.table = pd.read_csv(os.path.join(bucket_file, 'data.csv')).sort_values(by=['length'], ascending=False)
    ...
    def _load_wav(self, wav_path):
        wav=torch.load(os.path.join(self.libri_root,wav_path))
