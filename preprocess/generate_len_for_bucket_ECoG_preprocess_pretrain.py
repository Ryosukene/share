...
def generate_length(args, tr_set, audio_extension):
    ...
    for i, s in enumerate(tr_set):
        ...
        todo = list(Path(os.path.join('/home/negiryosuke/refine/s3prl/ECoG_data/M3predict_CommonAve_RegionLabel/', s)).rglob('*' + '.pt')) # '*.flac'
        ...
        output_dir = '/home/negiryosuke/refine/s3prl/ECoG_data/M3predict_CommonAve_RegionLabel/E_data_len_for_bucket'
        if not os.path.exists( '/home/negiryosuke/refine/s3prl/ECoG_data/M3predict_CommonAve_RegionLabel/E_data_len_for_bucket'): os.makedirs( '/home/negiryosuke/refine/s3prl/ECoG_data/M3predict_CommonAve_RegionLabel/E_data_len_for_bucket')
