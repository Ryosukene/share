...
def generate_length(args, tr_set, audio_extension):
    ...
    for i, s in enumerate(tr_set):
        ...
        print('')
        todo = list(Path(os.path.join('/home/negiryosuke/try/s3prl-master/s3prl/E_data5/', s)).rglob('*' + '.pt')) # '*.flac'
        ...
        output_dir = '/home/negiryosuke/try/s3prl-master/s3prl/E_data5/E_data_len_for_bucket'
        if not os.path.exists('/home/negiryosuke/try/s3prl-master/s3prl/E_data5/E_data_len_for_bucket'): os.makedirs('/home/negiryosuke/try/s3prl-master/s3prl/E_data5/E_data_len_for_bucket')
