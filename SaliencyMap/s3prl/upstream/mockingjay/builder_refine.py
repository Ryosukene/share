...
##########################
class PretrainedTransformer_refine(TransformerBuilder):
    """
    ...
    def __init__(
        ...
        super(PretrainedTransformer_refine, self).__init__(
    ...
    def forward(self, x):
        print('upstream/mockingjay/builder.PretrainedTransformer_forward')
        '''
...
####################################
class PretrainedTransformerWithHead(PretrainedTransformer_refine):
    def __init__(
        self, options, inp_dim, config=None, online_config=None, verbose=False
    ):
