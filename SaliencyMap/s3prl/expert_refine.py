...
#-------------#
from downstream.speaker_linear_utter_libri.model import Model
...
class DownstreamExpert(nn.Module):
    ...
    #def __init__(self, upstream_dim, downstream_expert, expdir, **kwargs):
        ...
        '''
        self.model = Model(input_dim=self.upstream_dim, output_class_num=7, **self.modelrc)
    ...
    def forward(self, mode, features, labels, **kwargs):
        """
        Args:
            features:
        ...
        #labals=labels.to(predicted.device)
